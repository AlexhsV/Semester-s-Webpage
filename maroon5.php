...
<html>
	<head>
		...
		<link rel="icon" href="favMar.png" type="image/x-icon">
    ...
    <body>
	    ...
	    <div class="menu"> 
		   <ul>
			  ...
			  <li><a href="http://localhost/php_6minou/maroon5.php"style=" font-weight: 1000;"> MAROON 5</a></li>
			  <li><a href="http://localhost/php_6minou/pinkfloyd.php">PINK FLOYD</a></li>
		...
		<table>
		  <tr class="row1">
			     ...
			     <td class="info1"> 
				    <div class="img_wrap">
			           <img class="alb" src="maroonalb1.png"  alt="alb1">
